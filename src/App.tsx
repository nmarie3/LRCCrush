...
function App() {
  ...
  const dragEnd = (e) => {
    ...
    const newCandies = [...currentCandies];
    newCandies[replacedItemId] = draggedItem.src;
    newCandies[draggedItemId] = replacedItem.src;
    ...
    if (isRowThrees || isColumnFours || isColumnThrees || isRowFours) {
      setDraggedItem(null)
      setReplacedItem(null)
    }else{
      newCandies[replacedItemId] = replacedItem.src;
      newCandies[draggedItemId] = draggedItem.src;
      setCurrentCandies(newCandies);
    }
  }
